...
public class SessionServiceImpl extends BaseServiceImpl<Session, SessionRep, SessionDto, SessionMapper> implements SessionService {
    public SessionServiceImpl(SessionRep sessionRep, SessionMapper mapper, CycleAvoidingMappingContext context, FilmService filmService, HallService hallService, PriceService priceService, FilmMapper filmMapper, CinemaService cinemaService, CinemaMapper cinemaMapper) {
